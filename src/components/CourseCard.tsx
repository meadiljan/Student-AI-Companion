...
const CourseCard: React.FC<CourseCardProps> = ({ title, instructor, progress, icon, color }) => {
  const IconComponent = Icons[icon] as React.ElementType;

  return (
    <div className="relative overflow-hidden rounded-3xl border border-white/20 bg-white/50 p-6 shadow-lg backdrop-blur-xl transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
